  ...
  return (
    <section id="founders" className="bg-white py-20">
      <div className="flex flex-col items-center gap-10 lg:gap-[60px] container">
        <h2 className="text-center text-xl lg:text-3xl font-semibold font-philosopher w-[30%]">
          ОТ СОЗДАТЕЛЕЙ MEDCITY
        </h2>
        <div className="w-full flex justify-between items-center gap-2">
          <p className="w-[50%] text-left text-base md:text-lg lg:text-xl font-manrope ">
        ...
        <div className="w-full flex lg:flex-row items-center justify-between gap-10 lg:gap-[60px] font-philosopher">
